...
CONCEPT_SOURCE_VALUES = {"SYSTEM", "CONTRACT", "AGREEMENT", "INCIDENT", "MANUAL", "CUSTOM", "REGULARIZATION"}
CALCULATION_TYPE_VALUES = {"FIXED_AMOUNT", "UNIT_PRICE", "FORMULA", "INCIDENT_ENGINE"}
