...
class CompanyBase(BaseModel):
    ...
    professional_contingencies_mutual: str | None = None
    professional_contingencies_policy: str | None = None
    professional_contingencies_effective_date: date | None = None
    common_it_mutual: str | None = None
    common_it_policy: str | None = None
    common_it_effective_date: date | None = None
    collective_insurance_enabled: bool = False
    collective_insurance_company: str | None = None
    collective_insurance_policy: str | None = None
    collective_insurance_capital: str | None = None
...
class CompanyUpdate(BaseModel):
    ...
    common_it_policy: str | None = None
    common_it_effective_date: date | None = None
    collective_insurance_enabled: bool | None = None
    collective_insurance_company: str | None = None
    collective_insurance_policy: str | None = None
    collective_insurance_capital: str | None = None
