...
class AgreementExtraPay(Base):
    ...
    payroll_period = Column(Integer, nullable=False, default=13)
    ...
    apply_partiality = Column(Boolean, nullable=False, default=True)
    deduct_it_days = Column(Boolean, nullable=False, default=False)
    deduct_unpaid_absence_days = Column(Boolean, nullable=False, default=True)
    deduct_inactivity_days = Column(Boolean, nullable=False, default=True)
