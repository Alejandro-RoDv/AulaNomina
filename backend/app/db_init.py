    ...
    with engine.begin() as connection:
        ...
        if "contracts" in table_names:
            ...
            contract_columns = {
                ...
                "seniority_date": "DATE",
                "seniority_criterion": "VARCHAR",
                "termination_reason": "VARCHAR",
                "transformation_from_contract_id": "INTEGER REFERENCES contracts(id)",
                "transformation_date": "DATE",
                "transformation_reason": "VARCHAR",
                "bonus_type": "VARCHAR",
                "bonus_start_date": "DATE",
                "bonus_end_date": "DATE",
                "bonus_fixed_fee": "NUMERIC(10, 2)",
                "bonus_observations": "VARCHAR",
                ...
                "ordinary_hours_period": "VARCHAR",
                "comparison_reference_type": "VARCHAR",
                "comparison_hours": "FLOAT",
                "work_distribution": "TEXT",
                "pay_accrual_mode": "VARCHAR",
                "contribution_hours_mode": "VARCHAR",
                "legal_workday_reduction_cause": "VARCHAR",
                "legal_workday_reduction_start": "DATE",
                "legal_workday_reduction_end": "DATE",
                "legal_workday_reduction_percentage": "FLOAT",
                "inactivity_start_date": "DATE",
                "inactivity_return_date": "DATE",
                "inactivity_start_communication_date": "DATE",
                "inactivity_return_communication_date": "DATE",
                "works_holidays": "BOOLEAN DEFAULT FALSE NOT NULL",
                "holiday_scope": "VARCHAR",
                "holiday_only_service_days": "BOOLEAN DEFAULT FALSE NOT NULL",
                "schedule_notes": "TEXT",
                "health_card_number": "VARCHAR",
                "subrogation": "BOOLEAN DEFAULT FALSE NOT NULL",
                "subrogation_company_origin": "VARCHAR",
                "subrogation_date": "DATE",
                "recognized_seniority_date": "DATE",
                "affects_extra_payments": "BOOLEAN DEFAULT FALSE NOT NULL",
                ...
                "red_cont": "VARCHAR",
                "cno_code": "VARCHAR",
                "cno_description": "VARCHAR",
                "company_cnae": "VARCHAR",
                "occupation": "VARCHAR",
                "it_rate": "FLOAT",
                "ims_rate": "FLOAT",
                ...
                "section": "VARCHAR",
                "group_name": "VARCHAR",
                "contract_registry_number": "VARCHAR",
                "contract_registry_date": "DATE",
                "contract_registry_office": "VARCHAR",
            ...
            connection.execute(
                text(
                    ...
                    SET full_time_weekly_hours = COALESCE(full_time_weekly_hours, 40),
                        ...
                        works_holidays = COALESCE(works_holidays, FALSE),
                        holiday_only_service_days = COALESCE(holiday_only_service_days, FALSE),
                        subrogation = COALESCE(subrogation, FALSE),
                        affects_extra_payments = COALESCE(affects_extra_payments, FALSE)
                    """
                )
            )
