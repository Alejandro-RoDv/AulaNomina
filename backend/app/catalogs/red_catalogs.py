SITUATION_CODES = [
    ...
    {"code": "54", "description": "Baja no voluntaria por otras causas / baja voluntaria art. 50 ET"},
    {"code": "55", "description": "Baja por fusión-absorción empresa"},
    {"code": "56", "description": "Baja por fallecimiento"},
    {"code": "58", "description": "Baja por pase a situación de pensionista"},
    {"code": "63", "description": "Baja por excedencia voluntaria / forzosa"},
    {"code": "65", "description": "Baja por agotamiento IT"},
    {"code": "67", "description": "Baja por paro estacional"},
    {"code": "68", "description": "Baja por excedencia maternal / cuidado de hijos"},
    {"code": "69", "description": "Baja por suspensión temporal ERE"},
    {"code": "73", "description": "Baja por cuidado de familiares"},
    {"code": "74", "description": "Baja por otras causas de suspensión"},
    {"code": "76", "description": "Baja por excedencia violencia de género / sexual / terrorismo"},
    {"code": "77", "description": "Baja por despido colectivo"},
    {"code": "80", "description": "Suspensión por violencia de género / violencia sexual"},
    {"code": "85", "description": "Baja por no superar el período de prueba"},
    {"code": "89", "description": "Baja por cambio de CCC. Datos por trabajador"},
