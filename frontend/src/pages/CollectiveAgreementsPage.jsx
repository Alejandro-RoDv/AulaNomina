...
function cleanPayload(payload) {
  return Object.fromEntries(Object.entries(payload).filter(([key]) => key !== "id" && key !== "table_id" && key !== "table_name" && key !== "table_year").map(([key, value]) => [key, value === "" ? null : value]));
}
