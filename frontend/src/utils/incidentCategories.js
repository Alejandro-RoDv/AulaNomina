export const INCIDENT_CATEGORY_TABS = [
  ...
  {
    value: "movement",
    label: "Variaciones laborales",
    shortLabel: "Variaciones",
    kind: "form",
    types: ["MOVIMIENTO"],
    defaultType: "MOVIMIENTO",
    title: "Registrar variación",
    subtitle: "Documenta variaciones de categoría, jornada, centro u otras condiciones con fecha de efectos.",
    submitLabel: "Registrar variación",
