...
const styles = {
  ...
  grid: { display: "grid", gridTemplateColumns: "repeat(4, minmax(170px, 1fr))", gap: "14px", padding: "16px" },
  economicGrid: { display: "grid", gridTemplateColumns: "minmax(180px, 0.65fr) minmax(180px, 0.65fr) minmax(320px, 1.7fr)", gap: "14px", padding: "16px" },
  field: { display: "flex", flexDirection: "column", gap: "6px", minWidth: 0 },
  notesField: { display: "flex", flexDirection: "column", gap: "6px", minWidth: 0 },
