    ...
    <form onSubmit={onSubmit} style={styles.form}>
      ...
      <Section title="Identificación personal">
        ...
        <div style={styles.formRow}>
          <div style={styles.formGroup}>
            <label>Nombre</label>
            <input name="first_name" value={form.first_name} onChange={onChange} required style={styles.input} />
          </div>
          <div style={styles.formGroup}>
            <label>Primer apellido</label>
            <input name="last_name" value={form.last_name} onChange={onChange} required style={styles.input} />
          </div>
          <div style={styles.formGroup}>
            <label>Segundo apellido</label>
            <input name="second_last_name" value={form.second_last_name} onChange={onChange} style={styles.input} />
          </div>
        </div>
        ...
        <div style={styles.formRow}>
          ...
          <div style={styles.formGroup}>
            ...
            <input name="birth_place" value={form.birth_place} onChange={onChange} style={styles.input} />
          </div>
        </div>
      </Section>
      ...
      <Section title="Contacto y domicilio">
        <div style={styles.formRow}>
          <div style={styles.formGroupWide}>
            ...
            <input name="domicile" value={form.domicile} onChange={onChange} style={styles.input} />
          </div>
        </div>
        <div style={styles.formRow}>
          <div style={styles.formGroupWide}>
        ...
        <div style={styles.formRow}>
          <div style={styles.formGroupSmall}>
            ...
            <input name="landline_phone" value={form.landline_phone} onChange={onChange} style={styles.input} />
          </div>
          <div style={styles.formGroupSmall}>
            <label>Móvil</label>
            <input name="mobile_phone" value={form.mobile_phone} onChange={onChange} style={styles.input} />
          </div>
          <div style={styles.formGroupSmall}>
          ...
          <div style={styles.formGroupSmall}>
            <label>Fax</label>
            <input name="fax" value={form.fax} onChange={onChange} style={styles.input} />
          </div>
        </div>
        <div style={styles.formRow}>
          <div style={styles.formGroup}>
      ...
      <Section title="Formación y perfil profesional">
        <div style={styles.formRow}>
          ...
          <div style={styles.formGroup}>
            ...
            <input name="academic_title" value={form.academic_title} onChange={onChange} style={styles.input} />
          </div>
          <div style={styles.formGroupSmall}>
            <label>Fecha concesión</label>
            <input name="academic_title_date" type="date" value={form.academic_title_date} onChange={onChange} style={styles.input} />
          </div>
        </div>
        <div style={styles.formRow}>
          <div style={styles.formGroup}>
            <label>Profesión principal</label>
            <input name="main_profession" value={form.main_profession} onChange={onChange} style={styles.input} />
          </div>
        </div>
        <div style={styles.formRow}>
          <div style={styles.formGroupTextarea}>
            <label>Otros cursos</label>
            <textarea name="other_courses" value={form.other_courses} onChange={onChange} style={styles.textarea} />
          </div>
          <div style={styles.formGroupTextarea}>
            <label>Acreditaciones</label>
            <textarea name="accreditations" value={form.accreditations} onChange={onChange} style={styles.textarea} />
          </div>
          <div style={styles.formGroupTextarea}>
            <label>Idiomas</label>
            <textarea name="languages" value={form.languages} onChange={onChange} style={styles.textarea} />
          </div>
        </div>
      </Section>
      ...
      <Section title="Representante y observaciones">
        <div style={styles.formRow}>
          <div style={styles.formGroup}>
            ...
            <input name="representative_role" value={form.representative_role} onChange={onChange} style={styles.input} />
          </div>
          <div style={styles.formGroupSmall}>
            <label>NIF representante</label>
            <input name="representative_nif" value={form.representative_nif} onChange={onChange} style={styles.input} />
          </div>
          <div style={styles.formGroup}>
            <label>Nombre y apellidos representante</label>
            <input name="representative_full_name" value={form.representative_full_name} onChange={onChange} style={styles.input} />
          </div>
        </div>
        <div style={styles.formRow}>
          <div style={styles.formGroupWide}>
            <label>Observaciones</label>
            <textarea name="observations" value={form.observations} onChange={onChange} style={styles.textareaLarge} />
          </div>
        </div>
      </Section>
